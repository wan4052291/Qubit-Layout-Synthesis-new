...
h q[48];
x q[49];
cp(0.20471795265251574) q[49],q[0];
cp(0.4094359053050315) q[49],q[1];
cp(0.818871810610063) q[49],q[2];
cp(1.637743621220126) q[49],q[3];
cp(-3.0076980647393343) q[49],q[4];
cp(0.2677891777009175) q[49],q[5];
cp(0.535578355401835) q[49],q[6];
cp(1.07115671080367) q[49],q[7];
cp(2.14231342160734) q[49],q[8];
cp(-1.9985584639649066) q[49],q[9];
cp(2.286068379249773) q[49],q[10];
cp(-1.7110485486800402) q[49],q[11];
cp(2.861088209819506) q[49],q[12];
cp(-0.5610088875405743) q[49],q[13];
cp(-1.1220177750811486) q[49],q[14];
cp(-2.2440355501622973) q[49],q[15];
cp(1.795114206854992) q[49],q[16];
cp(-2.6929568934696024) q[49],q[17];
cp(0.8972715202403814) q[49],q[18];
cp(1.7945430404807627) q[49],q[19];
cp(-2.6940992262180607) q[49],q[20];
cp(0.8949868547434644) q[49],q[21];
cp(1.7899737094869288) q[49],q[22];
cp(-2.7032378882057286) q[49],q[23];
cp(0.8767095307681287) q[49],q[24];
cp(1.7534190615362575) q[49],q[25];
swap q[23],q[25];
cp(-2.7763471841070713) q[49],q[26];
swap q[22],q[26];
cp(0.7304909389654439) q[49],q[27];
swap q[21],q[27];
cp(1.4609818779308879) q[49],q[28];
swap q[20],q[28];
cp(2.9219637558617757) q[49],q[29];
swap q[19],q[29];
cp(-0.43925779545603444) q[49],q[30];
swap q[18],q[30];
cp(-0.8785155909120689) q[49],q[31];
swap q[17],q[31];
cp(-1.7570311818241378) q[49],q[32];
swap q[16],q[32];
cp(2.7691229435313107) q[49],q[33];
swap q[15],q[33];
cp(-0.7449394201169645) q[49],q[34];
swap q[14],q[34];
cp(-1.489878840233929) q[49],q[35];
swap q[13],q[35];
cp(-2.979757680467858) q[49],q[36];
swap q[12],q[36];
cp(0.3236699462438703) q[49],q[37];
swap q[11],q[37];
cp(0.6473398924877406) q[49],q[38];
swap q[10],q[38];
cp(1.2946797849754812) q[49],q[39];
swap q[9],q[39];
cp(2.5893595699509624) q[49],q[40];
swap q[8],q[40];
cp(-1.1044661672776617) q[49],q[41];
swap q[7],q[41];
cp(-2.2089323345553233) q[49],q[42];
swap q[6],q[42];
cp(1.8653206380689396) q[49],q[43];
swap q[5],q[43];
cp(-13*pi/16) q[49],q[44];
swap q[4],q[44];
cp(3*pi/8) q[49],q[45];
swap q[3],q[45];
cp(3*pi/4) q[49],q[46];
