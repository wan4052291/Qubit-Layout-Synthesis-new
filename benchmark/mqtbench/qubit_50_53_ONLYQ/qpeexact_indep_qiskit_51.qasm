...
h q[49];
x q[50];
cp(0.20472822546781372) q[50],q[0];
cp(0.40945645093562744) q[50],q[1];
cp(0.8189129018712549) q[50],q[2];
cp(1.6378258037425097) q[50],q[3];
cp(-3.0075336996945667) q[50],q[4];
cp(0.26811790779045236) q[50],q[5];
cp(0.5362358155809047) q[50],q[6];
cp(1.0724716311618094) q[50],q[7];
cp(2.144943262323619) q[50],q[8];
cp(-1.9932987825323487) q[50],q[9];
cp(2.296587742114889) q[50],q[10];
cp(-1.6900098229498088) q[50],q[11];
cp(2.9031656612799686) q[50],q[12];
cp(-0.47685398461964923) q[50],q[13];
cp(-0.9537079692392985) q[50],q[14];
cp(-1.907415938478597) q[50],q[15];
cp(2.4683534302223924) q[50],q[16];
cp(-1.3464784467348012) q[50],q[17];
cp(-2.6929568934696024) q[50],q[18];
cp(0.8972715202403814) q[50],q[19];
cp(1.7945430404807627) q[50],q[20];
cp(-2.6940992262180607) q[50],q[21];
cp(0.8949868547434644) q[50],q[22];
cp(1.7899737094869288) q[50],q[23];
cp(-2.7032378882057286) q[50],q[24];
cp(0.8767095307681287) q[50],q[25];
swap q[24],q[25];
cp(1.7534190615362575) q[50],q[26];
swap q[23],q[26];
cp(-2.7763471841070713) q[50],q[27];
swap q[22],q[27];
cp(0.7304909389654439) q[50],q[28];
swap q[21],q[28];
cp(1.4609818779308879) q[50],q[29];
swap q[20],q[29];
cp(2.9219637558617757) q[50],q[30];
swap q[19],q[30];
cp(-0.43925779545603444) q[50],q[31];
swap q[18],q[31];
cp(-0.8785155909120689) q[50],q[32];
swap q[17],q[32];
cp(-1.7570311818241378) q[50],q[33];
swap q[16],q[33];
cp(2.7691229435313107) q[50],q[34];
swap q[15],q[34];
cp(-0.7449394201169645) q[50],q[35];
swap q[14],q[35];
cp(-1.489878840233929) q[50],q[36];
swap q[13],q[36];
cp(-2.979757680467858) q[50],q[37];
swap q[12],q[37];
cp(0.3236699462438703) q[50],q[38];
swap q[11],q[38];
cp(0.6473398924877406) q[50],q[39];
swap q[10],q[39];
cp(1.2946797849754812) q[50],q[40];
swap q[9],q[40];
cp(2.5893595699509624) q[50],q[41];
swap q[8],q[41];
cp(-1.1044661672776617) q[50],q[42];
swap q[7],q[42];
cp(-2.2089323345553233) q[50],q[43];
swap q[6],q[43];
cp(1.8653206380689396) q[50],q[44];
swap q[5],q[44];
cp(-13*pi/16) q[50],q[45];
swap q[4],q[45];
cp(3*pi/8) q[50],q[46];
swap q[3],q[46];
cp(3*pi/4) q[50],q[47];
