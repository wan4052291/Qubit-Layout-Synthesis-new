...
h q[50];
x q[51];
cp(0.20473336187546268) q[51],q[0];
cp(0.40946672375092535) q[51],q[1];
cp(0.8189334475018507) q[51],q[2];
cp(1.6378668950037014) q[51],q[3];
cp(-3.0074515171721834) q[51],q[4];
cp(0.26828227283521977) q[51],q[5];
cp(0.5365645456704395) q[51],q[6];
cp(1.073129091340879) q[51],q[7];
cp(2.146258182681758) q[51],q[8];
cp(-1.99066894181607) q[51],q[9];
cp(2.3018474235474464) q[51],q[10];
cp(-1.6794904600846932) q[51],q[11];
cp(2.9242043870102) q[51],q[12];
cp(-0.4347765331591867) q[51],q[13];
cp(-0.8695530663183734) q[51],q[14];
cp(-1.7391061326367467) q[51],q[15];
cp(2.8049730419060928) q[51],q[16];
cp(-0.6732392233674006) q[51],q[17];
cp(-1.3464784467348012) q[51],q[18];
cp(-2.6929568934696024) q[51],q[19];
cp(0.8972715202403814) q[51],q[20];
cp(1.7945430404807627) q[51],q[21];
cp(-2.6940992262180607) q[51],q[22];
cp(0.8949868547434644) q[51],q[23];
cp(1.7899737094869288) q[51],q[24];
cp(-2.7032378882057286) q[51],q[25];
cp(0.8767095307681287) q[51],q[26];
swap q[24],q[26];
cp(1.7534190615362575) q[51],q[27];
swap q[23],q[27];
cp(-2.7763471841070713) q[51],q[28];
swap q[22],q[28];
cp(0.7304909389654439) q[51],q[29];
swap q[21],q[29];
cp(1.4609818779308879) q[51],q[30];
swap q[20],q[30];
cp(2.9219637558617757) q[51],q[31];
swap q[19],q[31];
cp(-0.43925779545603444) q[51],q[32];
swap q[18],q[32];
cp(-0.8785155909120689) q[51],q[33];
swap q[17],q[33];
cp(-1.7570311818241378) q[51],q[34];
swap q[16],q[34];
cp(2.7691229435313107) q[51],q[35];
swap q[15],q[35];
cp(-0.7449394201169645) q[51],q[36];
swap q[14],q[36];
cp(-1.489878840233929) q[51],q[37];
swap q[13],q[37];
cp(-2.979757680467858) q[51],q[38];
swap q[12],q[38];
cp(0.3236699462438703) q[51],q[39];
swap q[11],q[39];
cp(0.6473398924877406) q[51],q[40];
swap q[10],q[40];
cp(1.2946797849754812) q[51],q[41];
swap q[9],q[41];
cp(2.5893595699509624) q[51],q[42];
swap q[8],q[42];
cp(-1.1044661672776617) q[51],q[43];
swap q[7],q[43];
cp(-2.2089323345553233) q[51],q[44];
swap q[6],q[44];
cp(1.8653206380689396) q[51],q[45];
swap q[5],q[45];
cp(-13*pi/16) q[51],q[46];
swap q[4],q[46];
cp(3*pi/8) q[51],q[47];
swap q[3],q[47];
cp(3*pi/4) q[51],q[48];
