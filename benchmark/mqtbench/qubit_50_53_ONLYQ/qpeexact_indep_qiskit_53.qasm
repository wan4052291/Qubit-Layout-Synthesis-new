...
h q[51];
x q[52];
cp(0.20473593007928717) q[52],q[0];
cp(0.40947186015857434) q[52],q[1];
cp(0.8189437203171487) q[52],q[2];
cp(1.6378874406342974) q[52],q[3];
cp(-3.0074104259109915) q[52],q[4];
cp(0.2683644553576035) q[52],q[5];
cp(0.536728910715207) q[52],q[6];
cp(1.073457821430414) q[52],q[7];
cp(2.146915642860828) q[52],q[8];
cp(-1.9893540214579304) q[52],q[9];
cp(2.3044772642637255) q[52],q[10];
cp(-1.6742307786521353) q[52],q[11];
cp(2.9347237498753156) q[52],q[12];
cp(-0.4137378074289554) q[52],q[13];
cp(-0.8274756148579108) q[52],q[14];
cp(-1.6549512297158215) q[52],q[15];
cp(2.973282847747943) q[52],q[16];
cp(-0.3366196116837003) q[52],q[17];
cp(-0.6732392233674006) q[52],q[18];
cp(-1.3464784467348012) q[52],q[19];
cp(-2.6929568934696024) q[52],q[20];
cp(0.8972715202403814) q[52],q[21];
cp(1.7945430404807627) q[52],q[22];
cp(-2.6940992262180607) q[52],q[23];
cp(0.8949868547434644) q[52],q[24];
cp(1.7899737094869288) q[52],q[25];
cp(-2.7032378882057286) q[52],q[26];
swap q[25],q[26];
cp(0.8767095307681287) q[52],q[27];
swap q[24],q[27];
cp(1.7534190615362575) q[52],q[28];
swap q[23],q[28];
cp(-2.7763471841070713) q[52],q[29];
swap q[22],q[29];
cp(0.7304909389654439) q[52],q[30];
swap q[21],q[30];
cp(1.4609818779308879) q[52],q[31];
swap q[20],q[31];
cp(2.9219637558617757) q[52],q[32];
swap q[19],q[32];
cp(-0.43925779545603444) q[52],q[33];
swap q[18],q[33];
cp(-0.8785155909120689) q[52],q[34];
swap q[17],q[34];
cp(-1.7570311818241378) q[52],q[35];
swap q[16],q[35];
cp(2.7691229435313107) q[52],q[36];
swap q[15],q[36];
cp(-0.7449394201169645) q[52],q[37];
swap q[14],q[37];
cp(-1.489878840233929) q[52],q[38];
swap q[13],q[38];
cp(-2.979757680467858) q[52],q[39];
swap q[12],q[39];
cp(0.3236699462438703) q[52],q[40];
swap q[11],q[40];
cp(0.6473398924877406) q[52],q[41];
swap q[10],q[41];
cp(1.2946797849754812) q[52],q[42];
swap q[9],q[42];
cp(2.5893595699509624) q[52],q[43];
swap q[8],q[43];
cp(-1.1044661672776617) q[52],q[44];
swap q[7],q[44];
cp(-2.2089323345553233) q[52],q[45];
swap q[6],q[45];
cp(1.8653206380689396) q[52],q[46];
swap q[5],q[46];
cp(-13*pi/16) q[52],q[47];
swap q[4],q[47];
cp(3*pi/8) q[52],q[48];
swap q[3],q[48];
cp(3*pi/4) q[52],q[49];
